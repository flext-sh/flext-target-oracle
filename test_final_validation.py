...
from flext_target_oracle import OracleConnector, OracleTarget
...
def test_project_final_validation():
    ...
    try:
        ...
        with open("flext_target_oracle/connectors.py") as f:
            content = f.read()
        ...
        with open("flext_target_oracle/sinks.py") as f:
            content = f.read()
