...
def create_sample_schema_message() -> m.TargetOracle.SingerSchemaMessage:
    ...
    Returns:
      dict[str, t.ContainerValue]: Singer SCHEMA message for users table
...
def create_sample_record_messages() -> list[m.TargetOracle.SingerRecordMessage]:
    ...
    Returns:
      List[dict[str, t.ContainerValue]]: List of Singer RECORD messages
...
def create_sample_state_message() -> m.TargetOracle.SingerStateMessage:
    ...
    Returns:
      dict[str, t.ContainerValue]: Singer STATE message with bookmark information
