...
{"type": "SCHEMA", "stream": "users", "schema": {"type": "t.NormalizedValue", "properties": {"id": {"type": "integer"}, "name": {"type": "string"}, "email": {"type": "string", "format": "email"}, "age": {"type": "integer"}, "address": {"type": "t.NormalizedValue", "properties": {"street": {"type": "string"}, "city": {"type": "string"}, "country": {"type": "string"}}}, "created_at": {"type": "string", "format": "date-time"}}}, "key_properties": ["id"]}
...
{"type": "SCHEMA", "stream": "products", "schema": {"type": "t.NormalizedValue", "properties": {"id": {"type": "integer"}, "name": {"type": "string"}, "price": {"type": "number"}, "category": {"type": "string"}, "in_stock": {"type": "boolean"}}}, "key_properties": ["id"]}
