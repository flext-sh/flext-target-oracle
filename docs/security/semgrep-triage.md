...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 623 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-target-oracle.json`
