...
- Primary facades: `FlextTargetOracleConstants`, `FlextTargetOracleModels`, `FlextTargetOracleProtocols`, `FlextTargetOracleService`, `FlextTargetOracleSettings`, `FlextTargetOracleTypes` (+1 more)
