...
- Primary facades: `FlextTargetOracle`, `FlextTargetOracleCli`, `FlextTargetOracleConstants`, `FlextTargetOracleModels`, `FlextTargetOracleProtocols`, `FlextTargetOracleService` (+3 more)
