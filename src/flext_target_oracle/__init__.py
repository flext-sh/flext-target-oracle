...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "FlextTargetOracleAuthenticationError": ("flext_target_oracle.target_exceptions", "FlextTargetOracleAuthenticationError"),
    "FlextTargetOracleCliService": ("flext_target_oracle.target_refactored", "FlextTargetOracleCliService"),
    "FlextTargetOracleConnectionError": ("flext_target_oracle.target_exceptions", "FlextTargetOracleConnectionError"),
    "FlextTargetOracleConstants": ("flext_target_oracle.constants", "FlextTargetOracleConstants"),
    "FlextTargetOracleError": ("flext_target_oracle.target_exceptions", "FlextTargetOracleError"),
    ...
    "FlextTargetOracleProcessingError": ("flext_target_oracle.target_exceptions", "FlextTargetOracleProcessingError"),
    "FlextTargetOracleProtocols": ("flext_target_oracle.protocols", "FlextTargetOracleProtocols"),
    "FlextTargetOracleSchemaError": ("flext_target_oracle.target_exceptions", "FlextTargetOracleSchemaError"),
