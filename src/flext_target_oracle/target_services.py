    ...
    async def get_table_columns(
        ...
        try:
            with self._oracle_api as connected_api:
                ...
                columns_result = connected_api.get_table_columns(
        ...
        try:
            with self._oracle_api as connected_api:
                ...
                if exec_result.is_failure:
                    return FlextResult.fail(f"Failed to create table: {exec_result.error}")
        ...
        try:
            ...
            if stream_name not in self._batches:
                ...
                self._statistics[stream_name] = LoadStatisticsModel(
                    stream_name=stream_name,
                    load_method_used=self._config.load_method,
                )
    ...
    async def flush_batch(self, stream_name: str) -> FlextResult[None]:
        ...
        try:
            ...
            with self._oracle_api as connected_api:
                ...
                batch_operations: list[tuple[str, dict[str, Any] | None]] = []
                ...
                # Update statistics
                stats = self._statistics[stream_name]
                self._statistics[stream_name] = stats.model_copy(update={
                    "successful_records": stats.successful_records + records_processed,
                    "total_records_processed": stats.total_records_processed + records_processed,
            ...
            for field_name, field_value in record.items():
                if field_name in properties:
                    ...
                    if expected_type == "string" and not isinstance(field_value, str):
                        ...
                        return FlextResult.fail(
                            f"Field {field_name} should be integer, got {type(field_value)}"
                        )
