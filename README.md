...
FLEXT Target Oracle - Singer Target for Oracle Database Data Loading

## Module Map

- Primary facades: `FlextTargetOracleExceptions`, `FlextTargetOracleServiceFactory`, `FlextTargetOracleLoader`, `FlextTargetOracleModelsSinger`, `FlextTargetOracleUtilitiesBase`, `FlextTargetOracleTypes` (+20 more)
- Alias namespaces: `c`, `d`, `e`, `h`, `m`, `p`, `r`, `s`, `t`, `u`, `x`
- Public symbol exports: `27`
...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-target-oracle` self).
...
- Public extensions exposed by this project: `FlextTargetOracleExceptions`, `FlextTargetOracleServiceFactory`, `FlextTargetOracleLoader`, `FlextTargetOracleModelsSinger`, `FlextTargetOracleUtilitiesBase`, `FlextTargetOracleTypes` (+20 more).
