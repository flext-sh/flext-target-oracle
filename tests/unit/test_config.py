...
class TestOracleSettings:
    ...
    def test_defaults_and_core_fields(self) -> None:
        config = FlextTargetOracleSettings(oracle_host='localhost', oracle_service_name='XE', oracle_user='test_user', oracle_password='test_pass')
    ...
    def test_get_oracle_config(self) -> None:
        config = FlextTargetOracleSettings(oracle_host='localhost', oracle_port=1521, oracle_service_name='XE', oracle_user='test', oracle_password='test', default_target_schema='TEST_SCHEMA', autocommit=True, transaction_timeout=120, parallel_degree=4, use_bulk_operations=True)
    ...
    def test_get_table_name_with_prefix_suffix_and_cleanup(self) -> None:
        config = FlextTargetOracleSettings(oracle_host='localhost', oracle_service_name='XE', oracle_user='test', oracle_password='test', table_prefix='stg_', table_suffix='_tbl')
    ...
    def test_validate_business_rules_failure_for_commit_interval(self) -> None:
        config = FlextTargetOracleSettings(oracle_host='localhost', oracle_service_name='XE', oracle_user='test', oracle_password='test', batch_size=100, commit_interval=200)
